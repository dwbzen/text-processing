...
public class PartsOfSpeech implements IJson {
	...
	static  {
		...
		// PosCategory category, String code, String name, String description, String parent, String qualifies
		...
		legacyPosMapping.put("M", new PartOfSpeech("maleName", PosCategory.noun, "M",  "Male Name", "noun", "properNoun"));
		
		partsOfSpeechLegacy.put("H", "Place names");
		legacyPosMapping.put("H", new PartOfSpeech("placeName", PosCategory.noun, "H",  "Place Name", "noun", "properNoun"));

		partsOfSpeechLegacy.put("F", "Female first name");
		legacyPosMapping.put("F", new PartOfSpeech("femaleName", PosCategory.noun, "F",  "Female Name", "noun", "properNoun"));
		
		partsOfSpeechLegacy.put("S", "Surname");
		legacyPosMapping.put("S", new PartOfSpeech("surname", PosCategory.noun, "S",  "Last Name", "noun", "properNoun"));
		...
		legacyPosMapping.put("c", new PartOfSpeech("color", PosCategory.adjective, "c",  "adjective representing a color", null, "adjective"));
		...
		legacyPosMapping.put("B", new PartOfSpeech("bodyPart", PosCategory.noun, "B",  "body part", "noun", "noun"));

		partsOfSpeechLegacy.put("b", "Male body part");
		legacyPosMapping.put("b", new PartOfSpeech("maleBodyPart", PosCategory.noun, "b",  "male body part", "noun", "bodyPart"));

		partsOfSpeechLegacy.put("d", "Female body part");
		legacyPosMapping.put("d", new PartOfSpeech("femaleBodyPart", PosCategory.noun, "d",  "female body part", "noun", "bodyPart"));
		...
		legacyPosMapping.put("4", new PartOfSpeech("cityName", PosCategory.noun, "4",  "City name", "noun", "placeName"));
		legacyPosMapping.put("5", new PartOfSpeech("countryName", PosCategory.noun, "5",  "Country name", "noun", "placeName"));
